...
| `DATA_DIRECTORY` | `./data`                                           | The directory where data is stored. Local uploads live under `{DATA_DIRECTORY}/uploads/`. See [Native filesystem storage](native-filesystem-storage.md). |
