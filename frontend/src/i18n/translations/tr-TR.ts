export default {
  ...
  "verify.success": "Hesabınız başarıyla doğrulandı! Artık giriş yapabilirsiniz.",
  ...
  "verify.info.description": "E-posta doğrulaması etkinleştirildi. E-posta adresinize bir doğrulama bağlantısı gönderdik. Hesabınızı etkinleştirmek için lütfen bağlantıya tıklayın.",
  ...
  "admin.config.general.default-language.description": "Bu tüm kullanıcılar için geçerlidir, her kullanıcı profilinde kendi dilini kişiselleştirebilir.",
  ...
  "admin.config.appearance.logo-dark.description": "Karanlık mod için ayrı bir logo yükleyin. Görsel PNG olmalı ve 1:1 oranında olmalıdır.",
  "admin.config.appearance.logo.placeholder": "Resim seç",
  "admin.config.security.custom-password-policy": "Özel şifre politikası",
  "admin.config.security.custom-password-policy.description": "Şifre politikasının özelleştirilmesini etkinleştirip etkinleştirmemek. Devre dışı bırakılırsa, varsayılan 8 karakterlik minimum şifre politikası kullanılır.",
  ...
  "admin.config.email.share-download-notification-message.description": "Bir alıcı dosya indirdiğinde paylaşımı oluşturana gönderilen mesaj. Kullanılabilir değişkenler:\n {recipientEmail} - Alıcının e-postası\n {fileName} - İndirilen dosya adı\n {shareUrl} - Paylaşımın URL'si",
  "admin.config.security.enable-email-verification": "E-posta doğrulamasını etkinleştir",
  "admin.config.security.enable-email-verification.description": "Kullanıcıların giriş yapabilmeden önce e-posta adreslerini doğrulamalarının gerekip gerekmediği. Bu yalnızca SMTP etkinse etkinleştirilebilir.",
  "admin.config.email.verification-subject": "Doğrulama konusu",
  "admin.config.email.verification-subject.description": "Kullanıcı kaydolduğunda gönderilen e-postanın konusu.",
  "admin.config.email.verification-message": "Doğrulama mesajı",
  "admin.config.email.verification-message.description": "Kullanıcı kaydolduğunda gönderilen mesaj. {url}, doğrulama URL'si ile değiştirilecektir.",
  ...
  "admin.config.share.file-retention-period.description": "Bir paylaşımın süresi dolduktan veya silindikten sonra dosyaların ne kadar süre saklanacağı. Yalnızca 'Yöneticilerin tüm paylaşımlara erişmesine izin ver' etkinse yararlıdır. Dosyaları sonsuza kadar saklamak için -1 olarak ayarlayın.",
  ...
  "admin.config.s3.enabled.description": "Paylaşılan dosyaları yerel dosya sistemi yerine S3'te saklayıp saklamamak. UYARI: ClamAV etkinse, kontrol edilmek üzere dosyalar geçici olarak S3'ten indirilecektir.",
  ...
  "error.msg.email_already_exists": "Bu e-posta adresine sahip bir hesap zaten var. Lütfen şifrenizle giriş yapın ve Hesabım sayfasından {0} hesabınızı manuel olarak bağlayın.",
