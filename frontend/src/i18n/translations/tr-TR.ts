export default {
  ...
  "verify.info.note": "Birkaç dakika içinde e-postayı almazsanız, lütfen spam klasörünüzü kontrol edin.",
  "verify.info.resend.button": "Doğrulama e-postasını tekrar gönder",
  "verify.info.resend.success": "Doğrulama e-postası başarıyla tekrar gönderildi.",
  ...
  "account.shares.table.restricted-to-recipients": "Yalnızca alıcılarla sınırlandırılmış",
  ...
  "account.shares.modal.edit.password.keep": "Mevcut şifreyi korumak için boş bırakın",
  ...
  "account.received-shares.description.empty": "E-posta adresinize gönderilen paylaşımlar burada görünecektir.",
  ...
  "admin.users.edit.update.custom-storage-quota-limit.description": "Kullanıcının aktif paylaşımlardaki toplam depolama kullanımını sınırlayın",
  ...
  "admin.users.modal.create.custom-share-size-limit": "Özel paylaşım boyutu sınırı",
  "admin.users.modal.create.custom-share-size-limit.description": "Bu kullanıcı için genel yükleme sınırını geçersiz kılın",
  "admin.users.modal.create.custom-storage-quota-limit": "Özel depolama kotası",
  "admin.users.modal.create.custom-storage-quota-limit.description": "Kullanıcının aktif paylaşımlardaki toplam depolama kullanımını sınırlayın",
  ...
  "upload.modal.link.error.s3-session-not-found": "S3 yükleme oturumu bulunamadı",
  "upload.modal.link.error.s3-etag-missing": "S3 yanıtında ETag başlığı eksik. CORS'un ETag başlığını sunduğundan emin olun.",
  ...
  "upload.modal.accordion.email.restrict-to-recipients": "Erişimi yalnızca bu alıcılarla sınırlandırın (erişmek için oturum açmaları gerekir)",
  ...
  "share.error.restricted.description": "Bu paylaşım belirli alıcılarla sınırlandırılmıştır. Erişmek için lütfen giriş yapın.",
  ...
  "share.notify.copy-too-big-error": "Dosya panoya kopyalanamayacak kadar büyük",
  "share.notify.copy-not-supported-error": "Panoya kopyalama için bir HTTPS bağlantısı gerekir",
  ...
  "admin.config.appearance.theme-color-scheme": "Varsayılan renk teması (misafirler)",
  "admin.config.appearance.theme-color-scheme.description": "Giriş yapmamış kullanıcılar için varsayılan açık/koyu tema. Giriş yapan kullanıcılar kendi hesap tercihlerini kullanır.",
  ...
  "admin.config.appearance.upload-progress-style.description": "Yükleme ilerlemesinin dosya listesinde nasıl görüntüleneceğini seçin.",
  "admin.config.appearance.upload-progress-style.circle": "Dairesel gösterge",
  "admin.config.appearance.upload-progress-style.circle-percentage": "Yüzdeli daire",
  "admin.config.appearance.upload-progress-style.percentage-time": "Yüzde ve kalan süre",
  ...
  "admin.config.security.min-length.description": "Bir şifre için gereken minimum karakter sayısı.",
  "admin.config.security.require-uppercase": "Büyük harf zorunlu",
  "admin.config.security.require-uppercase.description": "Şifrede en az bir büyük harf bulunmasını zorunlu kılın.",
  "admin.config.security.require-lowercase": "Küçük harf zorunlu",
  "admin.config.security.require-lowercase.description": "Şifrede en az bir küçük harf bulunmasını zorunlu kılın.",
  "admin.config.security.require-number": "Rakam zorunlu",
  "admin.config.security.require-number.description": "Şifrede en az bir rakam bulunmasını zorunlu kılın.",
  "admin.config.security.require-special-character": "Özel karakter zorunlu",
  "admin.config.security.require-special-character.description": "Şifrede en az bir özel karakter bulunmasını zorunlu kılın.",
  ...
  "admin.config.cache.test-redis.success-disabled": "Redis'e başarıyla bağlanıldı (Redis önbellekleme şu anda devre dışı).",
  "admin.config.cache.test-redis.modal.error.title": "Redis'e bağlanılamadı",
  "admin.config.cache.test-redis.modal.error.description": "Redis'e bağlanırken aşağıdaki hata oluştu:",
  "admin.config.cache.test-redis.modal.save.title": "Yapılandırmayı kaydet",
  "admin.config.cache.test-redis.modal.save.description": "Devam etmek için önce yapılandırmayı kaydetmeniz gerekir. Yapılandırmayı kaydedip Redis bağlantısını test etmek istiyor musunuz?",
  "admin.config.cache.test-redis.modal.save.confirm": "Kaydet ve test et",
  "admin.config.email.send-html-emails": "HTML e-posta uyumluluğunu etkinleştir",
  "admin.config.email.send-html-emails.description": "Etkinleştirilirse, e-postalar HTML formatında gönderilecektir. E-posta şablonlarının HTML kullanacak şekilde güncellendiğinden emin olun.",
  "admin.config.share.enable-share-email-recipients": "E-posta alıcılarıyla paylaşımı etkinleştir",
  "admin.config.share.enable-share-email-recipients.description": "Alıcılarla e-posta paylaşımına izin verilip verilmeyeceği. Bu yalnızca SMTP etkinse etkinleştirilebilir.",
  ...
  "admin.config.email.share-recipients-reply-to-creator": "Reply-To'yu oluşturanın e-postasına ayarla",
  "admin.config.email.share-recipients-reply-to-creator.description": "Reply-To başlığının paylaşımı oluşturan kullanıcının e-posta adresine ayarlanıp ayarlanmayacağı.",
  "admin.config.share.enable-share-download-notifications": "İndirme bildirimlerini etkinleştir",
  "admin.config.share.enable-share-download-notifications.description": "Bir e-posta alıcısı dosya indirdiğinde paylaşımı oluşturana bir e-posta gönderilip gönderilmeyeceği. Bu, SMTP ve e-posta alıcısı paylaşımını gerektirir.",
  "admin.config.email.share-download-notification-subject": "İndirme bildirimi konusu",
  "admin.config.email.share-download-notification-subject.description": "Bir alıcı dosya indirdiğinde paylaşımı oluşturana gönderilen e-postanın konusu.",
  "admin.config.email.share-download-notification-message": "İndirme bildirimi mesajı",
  ...
  "admin.config.security.enable-email-verification": "E-posta doğrulamasını etkinleştir",
  ...
  "admin.config.share.default-expiration.description": "Yeni bir paylaşım oluştururken seçilen varsayılan son kullanma süresi.",
  ...
  "admin.config.security.allow-admin-access-all-shares": "Yöneticilerin tüm paylaşımlara erişmesine izin ver",
  "admin.config.share.reverse-share-simple-only": "Karşı paylaşım basit modunu zorunlu kıl",
  "admin.config.share.reverse-share-simple-only.description": "Karşı paylaşımların basit modda oluşturulmasını zorunlu kılın. Devre dışı bırakılırsa, karşı paylaşımı oluşturan kişi basit ve gelişmiş mod arasında seçim yapabilir.",
  "admin.config.security.allow-admin-access-all-shares.description": "Yöneticilerin şifre korumalı, süresi dolmuş veya silinmiş olsalar bile tüm paylaşımlara erişmesine izin verin.",
  "admin.config.share.enable-user-recipients": "Kayıtlı kullanıcılarla paylaşımı etkinleştir",
  "admin.config.share.enable-user-recipients.description": "Etkinleştirildiğinde, kayıtlı bir kullanıcının e-posta adresine gönderilen paylaşımlar otomatik olarak hesaplarında görünecektir. Kullanıcılar ayrıca paylaşım erişimini yalnızca belirtilen alıcılarla kısıtlayabilir.",
  ...
  "admin.config.smtp.test-email.error.description": "Test e-postası gönderilirken aşağıdaki hata oluştu:",
  "admin.config.smtp.test-email.save.title": "Yapılandırmayı kaydet",
  "admin.config.smtp.test-email.save.description": "Devam etmek için önce yapılandırmayı kaydetmeniz gerekir. Yapılandırmayı kaydedip test e-postasını göndermek istiyor musunuz?",
  ...
  "admin.config.s3.docs-link": "Bucket'ınızda CORS yeniden yapılandırılmalıdır, ayrıntılar için {wikiLink} bağlantısına bakın.",
  ...
  "error.msg.email_not_verified": "Bu {0} hesabındaki e-posta adresiniz doğrulanmadı. Lütfen giriş yapmadan önce kimlik sağlayıcınızda e-postanızı doğrulayın.",
