export default {
  ...
  "verify.success": "Ваш налог је успешно верификован! Сада се можете пријавити.",
  ...
  "verify.info.description": "Верификација путем имејла је омогућена. Послали смо верификациони линк на вашу имејл адресу. Кликните на линк да активирате свој налог.",
  ...
  "upload.dropzone.description.mobile": "Изаберите датотеке или фасцикле да започнете дељење. Максимална укупна величина отпремања: {maxSize}.",
  "upload.dropzone.description.desktop": "Превуците и пустите датотеке или фасцикле овде или притисните {shortcut} да отпремите текст из међумеморије. Максимална укупна величина отпремања: {maxSize}.",
  "upload.dropzone.notify.file-too-big": "Ваше датотеке премашују максималну величину дељења од {maxSize}.",
  "upload.button.files": "Изабери датотеке",
  "upload.button.folder": "Изабери фасциклу",
  ...
  "admin.config.config-file-warning.description": "Пошто имате конфигурисан Pingvin Share са конфигурационом датотеком, не можете мењати конфигурацију преко корисничког интерфејса.",
  ...
  "admin.config.general.default-language.description": "Ово се односи на све кориснике, а сваки корисник и даље може прилагодити свој језик у свом профилу.",
  ...
  "admin.config.security.session-duration.description": "Време након којег се корисник мора поново пријавити (подразумевано: 3 месеца).",
  "admin.config.appearance.logo": "Лого",
  "admin.config.appearance.logo.description": "Промените свој логотип тако што ћете отпремити нову слику. Слика мора да буде PNG и треба да има формат 1:1.",
  "admin.config.appearance.logo-dark": "Лого за тамни режим",
  "admin.config.appearance.logo-dark.description": "Отпремите посебан лого за тамни режим. Слика мора бити PNG и треба да буде формата 1:1.",
  ...
  "admin.config.security.custom-password-policy.description": "Да ли омогућити прилагођавање политике лозинки. Ако је онемогућено, користи се подразумевана политика лозинки од минимум 8 знакова.",
  ...
  "admin.config.cache.ttl.description": "Време у секундама за чување информација унутар кеша.",
  ...
  "admin.config.cache.redis-enabled.description": "Pingvin Share обично кешира информације у меморији. Ако покрећете више инстанци Pingvin Share-а, потребно је да омогућите Redis кеширање да бисте делили кеш између инстанци.",
  "admin.config.cache.redis-url": "Redis URL",
  "admin.config.cache.redis-url.description": "Url за повезивање са Redis инстанцом која се користи за кеширање.",
  ...
  "admin.config.email.share-download-notification-message.description": "Порука која се шаље креатору дељења када прималац преузме датотеку. Доступне променљиве:\n {recipientEmail} - Имејл примаоца\n {fileName} - Назив преузете датотеке\n {shareUrl} - URL дељења",
  "admin.config.security.enable-email-verification": "Омогући верификацију имејла",
  "admin.config.security.enable-email-verification.description": "Да ли захтевати од корисника да верификују своју имејл адресу пре него што могу да се пријаве. Ово се може омогућити само ако је SMTP активиран.",
  "admin.config.email.verification-subject": "Тема верификације",
  "admin.config.email.verification-subject.description": "Тема имејла који се шаље кориснику приликом регистрације.",
  "admin.config.email.verification-message": "Порука верификације",
  "admin.config.email.verification-message.description": "Порука која се шаље кориснику приликом регистрације. {url} ће бити замењен верификационим URL-ом.",
  ...
  "admin.config.share.auto-open-share-modal": "Аутоматски отвори модал за креирање дељења",
  ...
  "admin.config.share.file-retention-period.description": "Колико дуго се датотеке чувају након што дељење истекне или буде избрисано. Корисно само ако је такође омогућено 'Дозволи администратору приступ свим дељењима'. Поставите на -1 да бисте чували датотеке заувек.",
  ...
  "admin.config.smtp.email.description": "Имејл адреса са које се шаљу имејлови",
  ...
  "admin.config.s3.enabled.description": "Да ли треба користити S3 за складиштење дељених датотека уместо локалног система датотека. УПОЗОРЕЊЕ: Ако је ClamAV активан, датотеке ће се привремено преузимати са S3 ради провере.",
  ...
  "admin.config.s3.bucket-path.description": "Подразумевана путања која се користи за складиштење датотека у S3 складишту.",
  ...
  "admin.config.legal.enabled.description": "Да ли приказати линк до импресума и политике приватности у подножју.",
  ...
  "admin.config.legal.imprint-url.description": "Ако већ имате страницу импресума можете је повезати овде уместо коришћења текстуалног поља.",
  ...
  "admin.config.legal.privacy-policy-url.description": "Ако већ имате страницу политике приватности можете је повезати овде уместо коришћења текстуалног поља.",
  // 404
  ...
  "error.msg.email_already_exists": "Налог са овом имејл адресом већ постоји. Пријавите се својом лозинком и ручно повежите свој {0} налог на страници Мој налог.",
