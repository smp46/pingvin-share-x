export default {
  ...
  "navbar.links.received": "Примљена дељења",
  ...
  // /auth/verify
  "verify.title": "Верификујте налог",
  "verify.success": "Your account has been verified. You can now sign in.",
  "verify.error": "Верификациони линк је неважећи или је истекао.",
  "verify.button.signin": "Иди на пријаву",
  "verify.info.title": "Верификација налога",
  "verify.info.description": "We sent a verification link to your email address. Open it to activate your account.",
  "verify.info.note": "Ако не примите имејл у року од неколико минута, проверите своју спам фасциклу.",
  "verify.info.resend.button": "Поново пошаљи верификациони имејл",
  "verify.info.resend.success": "Верификациони имејл је успешно поново послат.",
  "verify.info.resend.error": "Слање верификационог имејла није успело.",
  // END /auth/signup
  ...
  "common.button.showQRCode": "Прикажи QR код",
  ...
  "account.shares.button.edit": "Додај/уклони датотеке",
  ...
  "account.shares.table.password-protected": "Заштићено лозинком",
  "account.shares.table.recipients": "Примаоци",
  "account.shares.table.restricted-to-recipients": "Ограничено само на примаоце",
  "account.shares.table.shared-with-recipients": "Подељено са примаоцима",
  "account.shares.table.visitor-count": "{count} од {max}",
  "account.shares.table.expiry-never": "Никада",
  "account.shares.modal.share-informations": "Share information",
  "account.shares.modal.share-link": "Дели везу",
  "account.shares.modal.edit.password.keep": "Оставите празно да задржите тренутну лозинку",
  "account.shares.modal.edit.password.remove": "Уклони заштиту лозинком",
  ...
  // /account/received
  "account.received-shares.title": "Примљена дељења",
  "account.received-shares.title.empty": "Још увек нема примљених дељења",
  "account.received-shares.description.empty": "Дељења послата на вашу имејл адресу појавиће се овде.",
  "account.received-shares.table.from": "Од",
  ...
  "admin.users.table.storageQuota": "Складишна квота",
  "admin.users.table.maxShareSize": "Максимална величина дељења",
  ...
  "admin.users.edit.update.email-verified": "Имејл верификован",
  ...
  "admin.users.edit.update.custom-share-size-limit": "Прилагођено ограничење величине дељења",
  "admin.users.edit.update.custom-share-size-limit.description": "Премостите глобално ограничење отпремања за овог корисника",
  "admin.users.edit.update.custom-storage-quota-limit": "Прилагођена складишна квота",
  "admin.users.edit.update.custom-storage-quota-limit.description": "Ограничите укупну употребу складишта овог корисника кроз активна дељења",
  ...
  "admin.users.modal.create.custom-share-size-limit": "Прилагођено ограничење величине дељења",
  "admin.users.modal.create.custom-share-size-limit.description": "Премостите глобално ограничење отпремања за овог корисника",
  "admin.users.modal.create.custom-storage-quota-limit": "Прилагођена складишна квота",
  "admin.users.modal.create.custom-storage-quota-limit.description": "Ограничите укупну употребу складишта овог корисника кроз активна дељења",
  ...
  "admin.shares.diskUsage": "Употреба диска",
  ...
  "admin.shares.table.deletes": "Брише се",
  ...
  "upload.notify.duplicate-skipped": "Прескочена дуплирана датотека: {name}",
  ...
  "upload.filelist.estimating": "Процењивање...",
  "upload.filelist.remaining": "Преостало: {time}",
  ...
  "upload.modal.link.error.s3-session-not-found": "S3 сесија за отпремање није пронађена",
  "upload.modal.link.error.s3-etag-missing": "Недостаје ETag заглавље у S3 одговору. Уверите се да CORS излаже ETag заглавље.",
  ...
  "upload.modal.accordion.email.restrict-to-recipients": "Ограничи приступ само на ове примаоце (морају се пријавити да би приступили)",
  ...
  "share.fileCount": "{count, plural, =1 {# датотека} one {# датотека} few {# датотеке} other {# датотека}} · {size} (zip датотека може бити мања због компресије)",
  "share.copy-text-contents": "Копирај садржај датотеке у међумеморију",
  ...
  "share.error.restricted.title": "Ограничено дељење",
  "share.error.restricted.description": "Ово дељење је ограничено на одређене примаоце. Пријавите се да бисте му приступили.",
  "share.error.restricted.button": "Пријави се",
  "share.modal.password.title": "Обавезна лозинка",
  "share.modal.password.description": "Унесите лозинку за приступ овом дељењу.",
  ...
  "share.notify.copied-contents": "Садржај датотеке је копиран у међумеморију",
  "share.notify.copy-too-big-error": "Датотека је превелика за копирање у међумеморију",
  "share.notify.copy-not-supported-error": "Копирање у међумеморију захтева HTTPS везу",
  "share.modal.file-link": "Веза датотеке",
  "share.table.name": "Назив",
  "share.table.size": "Величина",
  "share.modal.file-preview.original_file": "Погледај оригиналну датотеку",
  ...
  // /admin/config
  "admin.config.config-file-warning.title": "Конфигурациона датотека је присутна",
  ...
  "admin.config.appearance.theme-color-scheme": "Подразумевана шема боја (гости)",
  "admin.config.appearance.theme-color-scheme.description": "Подразумевани светли/тамни режим за непријављене кориснике. Пријављени корисници користе сопствена подешавања налога.",
  ...
  "admin.config.appearance.upload-progress-style": "Стил напретка отпремања",
  "admin.config.appearance.upload-progress-style.description": "Изаберите како се напредак отпремања приказује у листи датотека.",
  "admin.config.appearance.upload-progress-style.circle": "Кружни индикатор",
  "admin.config.appearance.upload-progress-style.circle-percentage": "Круг са процентом",
  "admin.config.appearance.upload-progress-style.percentage-time": "Проценат и преостало време",
  ...
  "admin.config.security.secure-cookies": "Безбедни колачићи",
  "admin.config.security.secure-cookies.description": "Да ли желите да поставите заставицу за безбедност на колачиће? Ако је омогућено, сајт неће функционисати када му приступате преко HTTP-а.",
  ...
  "admin.config.security.session-duration": "Трајање сесије",
  ...
  "admin.config.appearance.logo-dark": "Лого за тамни режим",
  ...
  "admin.config.appearance.logo.placeholder": "Изабери слику",
  "admin.config.security.custom-password-policy": "Прилагођена политика лозинки",
  ...
  "admin.config.security.min-length": "Минимална дужина",
  "admin.config.security.min-length.description": "Минималан број знакова потребан за лозинку.",
  "admin.config.security.require-uppercase": "Захтевај велико слово",
  "admin.config.security.require-uppercase.description": "Да ли захтевати барем једно велико слово у лозинци.",
  "admin.config.security.require-lowercase": "Захтевај мало слово",
  "admin.config.security.require-lowercase.description": "Да ли захтевати барем једно мало слово у лозинци.",
  "admin.config.security.require-number": "Захтевај број",
  "admin.config.security.require-number.description": "Да ли захтевати барем један број у лозинци.",
  "admin.config.security.require-special-character": "Захтевај специјални знак",
  "admin.config.security.require-special-character.description": "Да ли захтевати барем један специјални знак у лозинци.",
  "admin.config.cache.ttl": "TTL",
  "admin.config.cache.ttl.description": "Time, in seconds, to keep data in the cache.",
  "admin.config.cache.max-items": "Максимално ставки",
  "admin.config.cache.max-items.description": "Максималан број ставки унутар кеша.",
  "admin.config.cache.redis-enabled": "Омогућен Redis",
  ...
  "admin.config.cache.button.test-redis": "Тестирај Redis везу",
  "admin.config.cache.test-redis.success": "Успешно повезано на Redis",
  "admin.config.cache.test-redis.success-disabled": "Успешно повезано на Redis (Redis кеширање је тренутно онемогућено).",
  "admin.config.cache.test-redis.modal.error.title": "Повезивање на Redis није успело",
  "admin.config.cache.test-redis.modal.error.description": "Приликом повезивања на Redis дошло је до следеће грешке:",
  "admin.config.cache.test-redis.modal.save.title": "Сачувај конфигурацију",
  "admin.config.cache.test-redis.modal.save.description": "Да бисте наставили, морате прво сачувати конфигурацију. Да ли желите да сачувате конфигурацију и тестирате Redis везу?",
  "admin.config.cache.test-redis.modal.save.confirm": "Сачувај и тестирај",
  "admin.config.email.send-html-emails": "Омогући компатибилност са HTML имејловима",
  "admin.config.email.send-html-emails.description": "Ако је омогућено, имејлови ће бити послати у HTML формату. Уверите се да су шаблони имејлова ажурирани да користе HTML.",
  "admin.config.share.enable-share-email-recipients": "Омогући дељење са примаоцима имејлом",
  "admin.config.share.enable-share-email-recipients.description": "Да ли омогућити дељење путем имејла са примаоцима. Ово се може омогућити само ако је SMTP активиран.",
  ...
  "admin.config.email.share-recipients-reply-to-creator": "Постави Reply-To на имејл креатора",
  "admin.config.email.share-recipients-reply-to-creator.description": "Да ли поставити Reply-To заглавље на имејл адресу корисника који је креирао дељење.",
  "admin.config.share.enable-share-download-notifications": "Омогући обавештења о преузимању",
  "admin.config.share.enable-share-download-notifications.description": "Да ли послати имејл креатору дељења када прималац преузме датотеку. Ово захтева SMTP и дељење са примаоцима путем имејла.",
  "admin.config.email.share-download-notification-subject": "Тема обавештења о преузимању",
  "admin.config.email.share-download-notification-subject.description": "Тема имејла који се шаље креатору дељења када прималац преузме датотеку.",
  "admin.config.email.share-download-notification-message": "Порука обавештења о преузимању",
  ...
  "admin.config.security.enable-email-verification": "Омогући верификацију имејла",
  ...
  "admin.config.email.verification-subject": "Тема верификације",
  "admin.config.email.verification-subject.description": "Subject of the email sent when a user signs up.",
  "admin.config.email.verification-message": "Порука верификације",
  ...
  "admin.config.security.allow-registration": "Дозволи регистрацију",
  "admin.config.security.allow-registration.description": "Да ли је регистрација дозвољена",
  "admin.config.security.allow-unauthenticated-shares": "Дозволи дељење без аутентификације",
  "admin.config.security.allow-unauthenticated-shares.description": "Да ли корисници без аутентификације могу да креирају дељења",
  "admin.config.share.default-expiration": "Подразумевани истек",
  "admin.config.share.default-expiration.description": "Подразумевано време истека изабрано приликом креирања новог дељења.",
  "admin.config.share.max-expiration": "Максимални рок трајања",
  "admin.config.share.max-expiration.description": "Максимално време истека дељења. Поставите на 0 да бисте омогућили неограничен истек.",
  ...
  "admin.config.security.allow-admin-access-all-shares": "Дозволи администратору приступ свим дељењима",
  "admin.config.share.reverse-share-simple-only": "Принудни једноставни режим за обрнуто дељење",
  "admin.config.share.reverse-share-simple-only.description": "Принуди креирање обрнутих дељења у једноставном режиму. Ако је онемогућено, креатор обрнутог дељења може бирати између једноставног и напредног режима.",
  "admin.config.security.allow-admin-access-all-shares.description": "Дозволи администраторима приступ свим дељењима, чак и ако су заштићена лозинком, истекла или избрисана.",
  "admin.config.share.enable-user-recipients": "Омогући дељење са регистрованим корисницима",
  "admin.config.share.enable-user-recipients.description": "Када је омогућено, дељења послата на имејл адресу регистрованог корисника аутоматски ће се појавити на његовом налогу. Корисници такође могу ограничити приступ дељењу само на именоване примаоце.",
  "admin.config.share.file-retention-period": "Период задржавања датотека",
  ...
  "admin.config.smtp.test-email.success": "Имејл је успешно послат",
  "admin.config.smtp.test-email.error.title": "Слање имејла није успело",
  "admin.config.smtp.test-email.error.description": "Приликом слања пробног имејла дошло је до следеће грешке:",
  "admin.config.smtp.test-email.save.title": "Сачувај конфигурацију",
  ...
  "admin.config.s3.enabled": "Омогућено",
  ...
  "admin.config.s3.endpoint.description": "URL S3 складишта (bucket).",
  "admin.config.s3.region": "Регион",
  "admin.config.s3.region.description": "Регион S3 складишта (bucket).",
  "admin.config.s3.bucket-name": "Назив складишта (bucket)",
  "admin.config.s3.bucket-name.description": "Назив S3 складишта (bucket).",
  "admin.config.s3.bucket-path": "Путања",
  "admin.config.s3.bucket-path.description": "Default path used to store files in the S3 bucket.",
  "admin.config.s3.key": "Кључ",
  "admin.config.s3.key.description": "Кључ који вам омогућава приступ S3 складишту.",
  "admin.config.s3.secret": "Тајни кључ",
  "admin.config.s3.secret.description": "Тајни кључ који вам омогућава приступ S3 складишту.",
  "admin.config.s3.use-checksum": "Користи контролну суму (checksum)",
  "admin.config.s3.use-checksum.description": "Искључите за позадинске системе који не подржавају контролну суму (нпр. B2).",
  "admin.config.s3.docs-link": "CORS мора бити поново конфигурисан на вашем складишту, погледајте {wikiLink} за детаље.",
  "admin.config.category.legal": "Правно",
  "admin.config.legal.enabled": "Омогући правна обавештења",
  "admin.config.legal.enabled.description": "Whether to show links to the imprint and privacy policy in the footer.",
  "admin.config.legal.imprint-text": "Текст импресума",
  "admin.config.legal.imprint-text.description": "Текст који треба да буде приказан у импресуму. Подржава Markdown. Оставите празно да бисте повезали са спољном страницом импресума.",
  "admin.config.legal.imprint-url": "URL импресума",
  "admin.config.legal.imprint-url.description": "Link to an existing imprint page instead of using the text field.",
  "admin.config.legal.privacy-policy-text": "Текст политике приватности",
  "admin.config.legal.privacy-policy-text.description": "Текст који треба да буде приказан у политици приватности. Подржава Markdown. Оставите празно да бисте повезали са спољном страницом политике приватности.",
  "admin.config.legal.privacy-policy-url": "URL политике приватности",
  ...
  "error.msg.email_not_verified": "Ваша имејл адреса на овом {0} налогу није верификована. Верификујте свој имејл код добављача идентитета пре пријаве.",
  ...
  "common.error.password.lowercase": "Лозинка мора садржати најмање једно мало слово",
  "common.error.password.uppercase": "Лозинка мора садржати најмање једно велико слово",
  "common.error.password.number": "Лозинка мора садржати најмање један број",
  "common.error.password.special": "Лозинка мора садржати најмање један специјални знак",
