export default {
  ...
  // /auth/verify
  "verify.title": "アカウントの確認",
  "verify.success":
    "アカウントが正常に確認されました。サインインできるようになりました。",
  "verify.error": "確認リンクが無効であるか、有効期限が切れています。",
  "verify.button.signin": "サインインへ進む",
  "verify.info.title": "アカウント確認",
  "verify.info.description":
    "メール確認が有効になっています。確認用リンクをメールアドレスに送信しました。リンクをクリックしてアカウントを有効化してください。",
  "verify.info.note":
    "数分経ってもメールが届かない場合は、迷惑メールフォルダをご確認ください。",
  "verify.info.resend.button": "確認メールを再送信",
  "verify.info.resend.success": "確認メールを正常に再送信しました。",
  "verify.info.resend.error": "確認メールの再送信に失敗しました。",
  // END /auth/signup
  ...
  "account.modal.unlink.description":
    "ソーシャルアカウントのリンクを解除すると、ログイン認証情報を忘れた場合にカウントへアクセスできなくなる可能性があります。",
  "account.notify.oauth.unlinked.success": "リンク解除に成功しました",
  "account.card.security.title": "セキュリティ",
  "account.card.security.totp.enable.description":
    "2段階認証を有効にするには、現在のパスワードを入力してください",
  "account.card.security.totp.disable.description":
    "2段階認証を無効にするには、現在のパスワードを入力してください",
  ...
  "account.shares.table.recipients": "受信者",
  "account.shares.table.restricted-to-recipients": "指定された受信者のみに制限",
  "account.shares.table.shared-with-recipients": "受信者と共有済み",
  ...
  // /account/received
  "account.received-shares.title": "受信した共有",
  "account.received-shares.title.empty": "まだ受信した共有はありません",
  "account.received-shares.description.empty":
    "あなたのメールアドレスに送信された共有がここに表示されます。",
  "account.received-shares.table.from": "送信者",
  "account.received-shares.button.open": "開く",
  ...
  "admin.users.modal.create.custom-share-size-limit": "カスタム共有サイズ制限",
  ...
  "upload.dropzone.description":
    "ファイルやフォルダをここにドラッグ＆ドロップして共有を開始するか、'Ctrl+V' でクリップボードからテキストコンテンツをアップロードします。合計で最大 {maxSize} までのファイルを受け付けます。",
  ...
  "upload.filelist.estimating": "計算中...",
  "upload.filelist.remaining": "残り {time}",
  ...
  "upload.modal.link.error.s3-session-not-found":
    "S3 アップロードセッションが見つかりません",
  "upload.modal.link.error.s3-etag-missing":
    "S3 レスポンスに ETag ヘッダーがありません。CORS で ETag ヘッダーが公開されていることを確認してください。",
  ...
  "upload.modal.accordion.email.restrict-to-recipients":
    "これらの受信者のみにアクセスを制限する (アクセスするにはサインインが必要です)",
  ...
  "share.fileCount":
    "{count, plural, =1 {# ファイル} other {# ファイル}} · {size} (圧縮により ZIP ファイルはより小さくなる場合があります)",
  ...
  "share.error.restricted.title": "制限された共有",
  "share.error.restricted.description":
    "この共有は特定の受信者に制限されています。アクセスするにはログインしてください。",
  "share.error.restricted.button": "ログイン",
  ...
  "admin.config.config-file-warning.description":
    "設定ファイル設定で済みのPingvin ShareはUI を使用して設定を変更することはできません。",
  "admin.config.title": "設定",
  "admin.config.category.general": "一般",
  "admin.config.category.appearance": "外観",
  "admin.config.category.security": "セキュリティとアクセス",
  ...
  "admin.config.security.secure-cookies": "セキュアクッキー",
  ...
  "admin.config.general.show-home-page.description":
    "ホームページを表示するかどうか選択",
  "admin.config.security.session-duration": "セッション期間",
  "admin.config.security.session-duration.description":
    "ユーザーが再度ログインするまでの時間（デフォルト: 3 ヶ月）。",
  "admin.config.appearance.logo": "ロゴ",
  "admin.config.appearance.logo.description":
    "新しい画像をアップロードしてロゴを変更できます。画像は、PNG形式でアスペクト比が1:1である必要があります。",
  "admin.config.appearance.logo-dark": "ダークモード用ロゴ",
  "admin.config.appearance.logo-dark.description":
    "ダークモード用の個別のロゴをアップロードします。画像は PNG 形式で、縦横比 1:1 である必要があります。",
  "admin.config.appearance.logo.placeholder": "画像を選択",
  "admin.config.security.custom-password-policy": "カスタムパスワードポリシー",
  "admin.config.security.custom-password-policy.description":
    "パスワードポリシーのカスタマイズを有効にするかどうか。無効にした場合、デフォルトの 8 文字以上のポリシーが使用されます。",
  "admin.config.security.min-length": "最小文字数",
  "admin.config.security.min-length.description":
    "パスワードに必要な最小文字数。",
  "admin.config.security.require-uppercase": "大文字を必須にする",
  "admin.config.security.require-uppercase.description":
    "パスワードに少なくとも 1 つの大文字を含めることを必須にするかどうか。",
  "admin.config.security.require-lowercase": "小文字を必須にする",
  "admin.config.security.require-lowercase.description":
    "パスワードに少なくとも 1 つの小文字を含めることを必須にするかどうか。",
  "admin.config.security.require-number": "数字を必須にする",
  "admin.config.security.require-number.description":
    "パスワードに少なくとも 1 つの数字を含めることを必須にするかどうか。",
  "admin.config.security.require-special-character": "特殊文字を必須にする",
  "admin.config.security.require-special-character.description":
    "パスワードに少なくとも 1 つの特殊文字を含めることを必須にするかどうか。",
  ...
  "admin.config.cache.redis-enabled.description":
    "通常、Pingvin Share は情報をメモリ内にキャッシュします。複数の Pingvin Share インスタンスを実行する場合は、インスタンス間でキャッシュを共有するために Redis キャッシュを有効にする必要があります。",
  "admin.config.cache.redis-url": "Redis URL",
  "admin.config.cache.redis-url.description":
    "キャッシュに使用する Redis インスタンスへの接続URL",
  "admin.config.cache.button.test-redis": "Redis 接続をテスト",
  "admin.config.cache.test-redis.success": "Redis に正常に接続しました",
  "admin.config.cache.test-redis.success-disabled":
    "Redis に正常に接続しました (現在 Redis キャッシュは無効になっています)。",
  "admin.config.cache.test-redis.modal.error.title":
    "Redis への接続に失敗しました",
  "admin.config.cache.test-redis.modal.error.description":
    "Redis への接続中に次のエラーが発生しました:",
  "admin.config.cache.test-redis.modal.save.title": "設定を保存",
  "admin.config.cache.test-redis.modal.save.description":
    "続行するには、まず設定を保存する必要があります。設定を保存して Redis 接続をテストしますか？",
  "admin.config.cache.test-redis.modal.save.confirm": "保存してテスト",
  "admin.config.email.send-html-emails": "HTML メールの互換性を有効にする",
  "admin.config.email.send-html-emails.description":
    "有効にすると、メールが HTML 形式で送信されます。メールテンプレートが HTML を使用するように更新されていることを確認してください。",
  "admin.config.share.enable-share-email-recipients":
    "メール受信者の共有を有効にする",
  "admin.config.share.enable-share-email-recipients.description":
    "受信者へのメール共有を許可するかどうか。これは SMTP が有効な場合のみ有効にできます。",
  ...
  "admin.config.share.chunk-size.description":
    "インターネット接続に応じて、効率と信頼性のバランスをとるためにアップロードのチャンクサイズ を調整します。チャンクを小さくすると、不安定な接続での成功率が向上し、チャンクを大きくすると、安定した接続でのアップロードが速くなります。",
  ...
  "admin.config.share.reverse-share-simple-only":
    "ファイルリクエストのシンプルモードを強制",
  "admin.config.share.reverse-share-simple-only.description":
    "ファイルリクエストをシンプルモードでのみ作成するように強制します。無効にすると、作成者はシンプルモードと高度なモードを選択できます。",
  "admin.config.security.allow-admin-access-all-shares.description":
    "管理者がパスワード保護、期限切れ、または削除された共有を含むすべての共有にアクセスすることを許可します。",
  "admin.config.share.enable-user-recipients":
    "登録ユーザーとの共有を有効にする",
  "admin.config.share.enable-user-recipients.description":
    "有効にすると、登録ユーザーのメールアドレス宛てに送信された共有がそのユーザーのアカウントに自動的に表示されます。ユーザーは共有へのアクセスを指定された受信者のみに制限することもできます。",
  "admin.config.share.file-retention-period": "ファイル保持期間",
  "admin.config.share.file-retention-period.description":
    "共有の期限切れまたは削除後にファイルを保持する期間。「すべての共有への管理者アクセスを許可」が有効な場合のみ有効です。ファイルを永続的に保持するには -1 に設定します。",
  ...
  "admin.config.smtp.test-email.success": "テストメールが正常に送信されました",
  "admin.config.smtp.test-email.error.title": "メールの送信に失敗しました",
  "admin.config.smtp.test-email.error.description":
    "テストメールの送信中に次のエラーが発生しました:",
  "admin.config.smtp.test-email.save.title": "設定を保存",
  "admin.config.smtp.test-email.save.description":
    "続行するには、まず設定を保存する必要があります。設定を保存してテストメールを送信しますか？",
  "admin.config.smtp.test-email.save.confirm": "保存して送信",
  ...
  "admin.config.oauth.oidc-scope.description":
    "OpenID Connect プロバイダーから要求する必要があるスコープ。",
  ...
  "admin.config.notify.logo-success":
    "ロゴが正常に更新されました。Web サイトで更新されるまでに数分かかる場合があります。",
  "admin.config.notify.no-changes": "保存する変更がありません。",
  "admin.config.category.s3": "S3",
  "admin.config.s3.enabled": "有効",
  "admin.config.s3.enabled.description":
    "ローカルファイルシステムの代わりに S3 を使用して共有ファイルを保存するかどうか。警告: ClamAV が有効な場合、スキャン対象のファイルは一時的に S3 からダウンロードされます。",
  "admin.config.s3.endpoint": "エンドポイント",
  ...
  "admin.config.s3.bucket-path.description":
    "S3バケットにファイルを格納するために使用されるデフォルトのパス。",
  ...
  "error.msg.email_already_exists":
    "このメールアドレスのアカウントは既に存在します。パスワードでサインインし、マイアカウントページで手動で {0} アカウントを連携してください。",
  "error.msg.email_not_verified":
    "この {0} アカウントのメールアドレスは確認されていません。サインインする前に ID プロバイダーでメールアドレスを確認してください。",
  ...
  "admin.notice.modal.globalNoticeFooter":
    "注: 一度確認すると、この通知はすべてのデバイスのすべての管理者に対して永久に非表示になります。",
};
