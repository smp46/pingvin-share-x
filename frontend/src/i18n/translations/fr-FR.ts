export default {
  ...
  "admin.users.edit.update.custom-storage-quota-limit.description": "Limiter l'utilisation totale du stockage de l'utilisateur sur tous ses partages actifs",
  ...
  "admin.users.modal.create.custom-storage-quota-limit.description": "Limiter l'utilisation totale du stockage de l'utilisateur sur tous ses partages actifs",
  ...
  "upload.modal.link.error.s3-session-not-found": "Session de téléversement S3 introuvable",
  "upload.modal.link.error.s3-etag-missing": "En-tête ETag manquant dans la réponse S3. Assurez-vous que CORS expose l'en-tête ETag.",
  ...
  "admin.config.security.secure-cookies.description": "Définir ou non le marquage sécurisé sur les cookies. Si activé, le site ne fonctionnera pas lorsqu'il est accédé via HTTP.",
  ...
  "admin.config.security.custom-password-policy": "Politique de mot de passe personnalisée",
  ...
  "admin.config.security.min-length.description": "Nombre minimum de caractères requis pour un mot de passe.",
  "admin.config.security.require-uppercase": "Exiger des majuscules",
  "admin.config.security.require-uppercase.description": "Exiger ou non au moins une lettre majuscule dans le mot de passe.",
  "admin.config.security.require-lowercase": "Exiger des minuscules",
  "admin.config.security.require-lowercase.description": "Exiger ou non au moins une lettre minuscule dans le mot de passe.",
  "admin.config.security.require-number": "Exiger des chiffres",
  "admin.config.security.require-number.description": "Exiger ou non au moins un chiffre dans le mot de passe.",
  "admin.config.security.require-special-character": "Exiger des caractères spéciaux",
  "admin.config.security.require-special-character.description": "Exiger ou non au moins un caractère spécial dans le mot de passe.",
  ...
  "admin.config.share.enable-share-email-recipients": "Activer le partage par courriel",
  "admin.config.share.enable-share-email-recipients.description": "Autoriser ou non le partage d'e-mails avec les destinataires. Cette option n'est disponible que si le protocole SMTP est activé.",
  ...
  "admin.config.share.enable-share-download-notifications": "Activer les notifications de téléchargement",
  "admin.config.share.enable-share-download-notifications.description": "S'il faut envoyer un e-mail au créateur du partage lorsqu'un destinataire télécharge un fichier. Cela nécessite un protocole SMTP et le partage par e-mail.",
  ...
  "admin.config.security.enable-email-verification": "Activer l'email de vérification",
  ...
  "admin.config.security.allow-registration.description": "Permet aux visiteurs de créer un compte",
  "admin.config.security.allow-unauthenticated-shares": "Autoriser les partages anonymes",
  "admin.config.security.allow-unauthenticated-shares.description": "Permet aux visiteurs de créer des partages",
  ...
  "admin.config.security.allow-admin-access-all-shares": "Autoriser l'accès admin à tous les partages",
  ...
  "admin.config.security.allow-admin-access-all-shares.description": "Autoriser les administrateurs à accéder à tous les partages, même s'ils sont protégés par un mot de passe, expirés ou supprimés.",
  ...
  "admin.config.s3.docs-link": "CORS doit être reconfiguré sur votre compartiment (bucket), consultez le {wikiLink} pour plus de détails.",
  ...
  "error.msg.email_not_verified": "Votre adresse email sur ce compte {0} n'est pas vérifiée. Veuillez vérifier votre email auprès de votre fournisseur d'identité avant de vous connecter.",
  ...
  "common.error.password.lowercase": "Le mot de passe doit contenir au moins une lettre minuscule",
  "common.error.password.uppercase": "Le mot de passe doit contenir au moins une lettre majuscule",
  "common.error.password.number": "Le mot de passe doit contenir au moins un chiffre",
  "common.error.password.special": "Le mot de passe doit contenir au moins un caractère spécial",
