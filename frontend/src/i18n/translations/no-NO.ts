export default {
  ...
  "admin.config.security.session-duration.description": "Tid før en bruker må logge inn på nytt (standard: 3 måneder).",
  "admin.config.appearance.logo": "Logo",
  "admin.config.appearance.logo.description": "Endre logoen din ved å laste opp et nytt bilde. Bildet må være i PNG-format og ha størrelsesforholdet 1:1.",
  "admin.config.appearance.logo-dark": "Logo for mørk modus",
  "admin.config.appearance.logo-dark.description": "Last opp en egen logo for mørk modus. Bildet må være i PNG-format og ha størrelsesforholdet 1:1.",
  ...
  "admin.config.security.custom-password-policy.description": "Hvorvidt tilpasning av passordpolicyen skal aktiveres. Hvis deaktivert, brukes standard passordpolicy med minimum 8 tegn.",
  ...
  "admin.config.security.enable-email-verification.description": "Om brukere må verifisere e-postadressen sin før de kan logge inn. Dette kan bare aktiveres dersom SMTP er aktivert.",
  ...
  "error.msg.email_already_exists": "En konto med denne e-postadressen finnes allerede. Vennligst logg inn med passordet ditt og koble til {0}-kontoen din manuelt på Min konto-siden.",
