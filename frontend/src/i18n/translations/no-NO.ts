export default {
  ...
  "verify.info.note":
    "Hvis du ikke mottar e-posten innen få minutter, vennligst sjekk søppelpostmappen din.",
  ...
  "account.shares.modal.edit.password.keep":
    "La feltet stå tomt for å beholde gjeldende passord",
  ...
  "account.shares.modal.delete.description":
    "Vil du virkelig slette denne delingen?",
  // END /account/shares
  ...
  "account.received-shares.description.empty":
    "Delinger sendt til din e-postadresse vil vises her.",
  ...
  "account.reverseShare.never-expires":
    "Denne omvendte delingen vil aldri utløpe.",
  "account.reverseShare.expires-on":
    "Denne omvendte delingen utløper den {expiration}.",
  ...
  "admin.users.edit.update.custom-share-size-limit":
    "Egendefinert grense for delingsstørrelse",
  "admin.users.edit.update.custom-share-size-limit.description":
    "Overstyr den globale opplastingsgrensen for denne brukeren",
  "admin.users.edit.update.custom-storage-quota-limit":
    "Egendefinert lagringskvote",
  "admin.users.edit.update.custom-storage-quota-limit.description":
    "Begrens brukerens totale lagringsbruk på tvers av aktive delinger",
  ...
  "upload.notify.generic-error":
    "Det oppstod en feil under fullføring av delingen din.",
  "upload.notify.count-failed":
    "{count} filer kunne ikke lastes opp. Prøver på nytt.",
  ...
  "upload.dropzone.description":
    "Dra og slipp filer eller mapper her for å starte delingen, eller trykk «Ctrl+V» for å laste opp tekstinnhold fra utklippstavlen. Vi godtar bare filer opptil {maxSize} totalt.",
  ...
  "upload.modal.link.error.s3-session-not-found":
    "S3-opplastingsøkt ble ikke funnet",
  "upload.modal.link.error.s3-etag-missing":
    "Mangler ETag-header i S3-respons. Sørg for at CORS eksponerer ETag-headeren.",
  ...
  "upload.modal.expires.error.too-long":
    "Utløpsdatoen overskrider maksgrensen på {max}.",
  ...
  "upload.modal.accordion.email.restrict-to-recipients":
    "Begrens tilgangen til kun disse mottakerne (de må logge inn for å få tilgang)",
  ...
  "upload.modal.completed.expires-on":
    "Denne delingen utløper den {expiration}.",
  ...
  "share.error.not-found.description":
    "Delingen du leter etter eksisterer ikke.",
  ...
  "share.error.restricted.description":
    "Denne delingen er begrenset til bestemte mottakere. Vennligst logg inn for å få tilgang.",
  "share.error.restricted.button": "Logg inn",
  "share.modal.password.title": "Passord kreves",
  "share.modal.password.description":
    "Vennligst skriv inn passordet for å få tilgang til denne delingen.",
  ...
  "share.notify.copy-too-big-error":
    "Filen er for stor til å kopieres til utklippstavlen",
  "share.notify.copy-not-supported-error":
    "Kopiering til utklippstavlen krever en HTTPS-tilkobling",
  ...
  "admin.config.appearance.theme-radius.description":
    "Standard hjørneradius brukt av Mantine-komponenter.",
  ...
  "admin.config.appearance.upload-progress-style":
    "Stil for opplastingsfremdrift",
  "admin.config.appearance.upload-progress-style.description":
    "Velg hvordan opplastingsfremdriften skal vises i fillisten.",
  ...
  "admin.config.appearance.upload-progress-style.percentage-time":
    "Prosent og gjenværende tid",
  "admin.config.general.app-url": "App-URL",
  "admin.config.general.app-url.description":
    "Hvilken URL Pingvin Share er tilgjengelig på",
  "admin.config.security.secure-cookies":
    "Sikre informasjonskapsler (Secure cookies)",
  ...
  "admin.config.security.require-special-character.description":
    "Hvorvidt det skal kreves minst ett spesialtegn i passordet.",
  "admin.config.cache.ttl": "TTL",
  "admin.config.cache.ttl.description":
    "Tid i sekunder informasjon skal beholdes i mellomlageret.",
  "admin.config.cache.max-items": "Maks antall elementer",
  "admin.config.cache.max-items.description":
    "Maksimalt antall elementer i mellomlageret.",
  ...
  "admin.config.cache.redis-url.description":
    "URL for å koble til Redis-instansen som brukes til mellomlagring.",
  ...
  "admin.config.share.enable-share-email-recipients":
    "Aktiver deling med e-postmottakere",
  ...
  "admin.config.email.reset-password-subject":
    "Emne for tilbakestilling av passord",
  ...
  "admin.config.email.reset-password-message":
    "Melding for tilbakestilling av passord",
  ...
  "admin.config.email.share-recipients-reply-to-creator":
    "Sett Svar-til til oppretterens e-post",
  "admin.config.email.share-recipients-reply-to-creator.description":
    "Hvorvidt Reply-To-headeren skal settes til e-postadressen til brukeren som opprettet delingen.",
  "admin.config.share.enable-share-download-notifications":
    "Aktiver nedlastingsvarsler",
  ...
  "admin.config.security.allow-registration.description":
    "Om registrering skal være tillatt",
  "admin.config.security.allow-unauthenticated-shares":
    "Tillat uautoriserte delinger",
  ...
  "admin.config.security.allow-admin-access-all-shares":
    "Tillat administratorer tilgang til alle delinger",
  "admin.config.share.reverse-share-simple-only":
    "Tving enkel modus for omvendt deling",
  "admin.config.share.reverse-share-simple-only.description":
    "Tving omvendte delinger til å opprettes i enkel modus. Hvis deaktivert, kan oppretteren av den omvendte delingen velge mellom enkel og avansert modus.",
  ...
  "admin.config.share.enable-user-recipients":
    "Aktiver deling med registrerte brukere",
  "admin.config.share.enable-user-recipients.description":
    "Når aktivert, vil delinger sendt til en registrert brukers e-postadresse automatisk vises i kontoen deres. Brukere kan også begrense delingstilgangen til kun navngitte mottakere.",
  ...
  "admin.config.smtp.email.description":
    "E-postadresse som e-postene sendes fra",
  ...
  "admin.config.smtp.allow-unauthorized-certificates":
    "Stol på uautoriserte SMTP-serversertifikater",
  ...
  "admin.config.oauth.allow-registration.description":
    "Tillat brukere å registrere seg via sosial innlogging",
  "admin.config.oauth.ignore-totp": "Ignorer TOTP",
  "admin.config.oauth.ignore-totp.description":
    "Om TOTP skal ignoreres når brukeren benytter sosial innlogging",
  ...
  "admin.config.oauth.github-enabled.description":
    "Om GitHub-innlogging er aktivert",
  ...
  "admin.config.oauth.google-enabled.description":
    "Om Google-innlogging er aktivert",
  ...
  "admin.config.oauth.microsoft-enabled.description":
    "Om Microsoft-innlogging er aktivert",
  ...
  "admin.config.oauth.discord-enabled.description":
    "Om Discord-innlogging er aktivert",
  ...
  "admin.config.oauth.oidc-enabled.description":
    "Om OpenID Connect-innlogging er aktivert",
  "admin.config.oauth.oidc-discovery-uri": "OpenID Connect Discovery-URI",
  "admin.config.oauth.oidc-discovery-uri.description":
    "Discovery URI for OpenID Connect-appen",
  ...
  "admin.config.oauth.oidc-scope.description":
    "Scoper som skal forespørres fra OpenID Connect-tilbyderen.",
  ...
  "admin.config.oauth.oidc-role-general-access":
    "OpenID Connect-rolle for generell tilgang",
  ...
  "admin.config.oauth.oidc-role-admin-access":
    "OpenID Connect-rolle for administratortilgang",
  ...
  "admin.config.ldap.admin-groups.description":
    "Gruppe som kreves for administratortilgang.",
  ...
  "admin.config.ldap.field-name-email.description":
    "LDAP-attributtnavn for brukerens e-post.",
  ...
  "admin.config.s3.bucket-path.description":
    "Standardstien som skal brukes til å lagre filene i S3-bøtten.",
  "admin.config.s3.key": "Nøkkel (Key)",
  "admin.config.s3.key.description":
    "Nøkkelen som gir deg tilgang til S3-bøtten.",
  "admin.config.s3.secret": "Hemmelighet (Secret)",
  "admin.config.s3.secret.description":
    "Hemmeligheten som gir deg tilgang til S3-bøtten.",
  "admin.config.s3.use-checksum": "Bruk sjekksum",
  "admin.config.s3.use-checksum.description":
    "Slå av for backender som ikke støtter sjekksum (f.eks. B2).",
  "admin.config.s3.docs-link":
    "CORS må rekonfigureres på bøtten din, se {wikiLink} for detaljer.",
  ...
  "admin.config.legal.enabled.description":
    "Om det skal vises en lenke to impressum og personvernerklæring i bunnteksten.",
  ...
  "error.msg.access_denied":
    "Du avbrøt autentiseringsprosessen, vennligst prøv igjen.",
  "error.msg.expired_token":
    "Autentiseringsprosessen tok for lang tid, vennligst prøv igjen.",
  "error.msg.invalid_token": "Intern feil",
  "error.msg.no_user":
    "Brukeren som er koblet til denne {0}-kontoen, eksisterer ikke.",
  "error.msg.no_email": "Kan ikke hente e-postadresse fra denne {0}-kontoen.",
  "error.msg.already_linked":
    "Denne {0}-kontoen er allerede koblet til en annen konto.",
  "error.msg.not_linked":
    "Denne {0}-kontoen har ikke blitt koblet til noen konto ennå.",
  "error.msg.email_already_exists":
    "En konto med denne e-postadressen finnes allerede. Vennligst logg inn med passordet ditt og koble til {0}-kontoen din manuelt på Min konto-siden.",
  "error.msg.email_not_verified":
    "E-postadressen din på denne {0}-kontoen er ikke verifisert. Vennligst verifiser e-posten din hos identitetsleverandøren din før du logger inn.",
  "error.msg.unverified_account":
    "Denne {0}-kontoen er ikke verifisert. Prøv igjen etter verifisering.",
  "error.msg.user_not_allowed": "Du har ikke tillatelse til å logge inn.",
  "error.msg.cannot_get_user_info":
    "Kan ikke hente brukerinformasjonen din fra denne {0}-kontoen.",
  ...
  "admin.notice.modal.defaultCheckboxLabel":
    "Jeg bekrefter at jeg har lest denne meldingen og forstår de omfattende endringene.",
  ...
  "admin.notice.modal.globalNoticeFooter":
    "Merk: Når den er bekræftet, vil denne meldingen bli permanent fjernet for alle administratorer på tvers av alle enheter.",
};
