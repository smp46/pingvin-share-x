export default {
  ...
  "admin.shares.table.scan": "Skan",
  "admin.shares.scan.pending": "Oczekuje na skan antywirusowy",
  ...
  "admin.shares.block.block": "Zablokuj udostępnienie",
  "admin.shares.block.unblock": "Odblokuj udostępnienie",
  "admin.shares.block.action": "Zablokuj",
  "admin.shares.block.badge": "Zablokowane",
  "admin.shares.block.title": "Zablokuj udostępnienie: {id}",
  "admin.shares.block.description": "Pliki zostają na serwerze, więc nadal możesz je zbadać, ale udostępnienie otworzą tylko administratorzy. Wszyscy pozostali, łącznie z właścicielem, zobaczą komunikat o nieznalezieniu.",
  "admin.shares.block.reason": "Powód",
  "admin.shares.block.reason.placeholder": "Widoczny tylko dla administratorów",
  "admin.shares.block.no-reason": "Nie podano powodu",
  "admin.shares.block.blocked": "Udostępnienie zablokowane",
  "admin.shares.block.unblocked": "Udostępnienie odblokowane",
  ...
  "admin.shares.filter.quickRange": "Utworzone w ciągu...",
  "admin.shares.filter.range.15m": "Ostatnich 15 minut",
  "admin.shares.filter.range.1h": "Ostatniej godziny",
  "admin.shares.filter.range.6h": "Ostatnich 6 godzin",
  "admin.shares.filter.range.12h": "Ostatnich 12 godzin",
  "admin.shares.filter.range.1d": "Ostatniego dnia",
  "admin.shares.filter.range.2d": "Ostatnich 2 dni",
  "admin.shares.filter.range.3d": "Ostatnich 3 dni",
  "admin.shares.filter.range.7d": "Ostatnich 7 dni",
  ...
  "admin.shares.notify.bulk-delete-failed": "Nie udało się usunąć {failed} z {total} udostępnień, lista została odświeżona",
  // END /admin/shares
  ...
  "share.anonymous-warning.banner.title": "Udostępnienie anonimowe",
  "share.anonymous-warning.banner.description": "To udostępnienie zostało utworzone bez zalogowanego konta. Te pliki mógł tu umieścić każdy — traktuj je i otwieraj z taką samą ostrożnością jak pliki z otwartego internetu.",
  ...
  "share.modal.anonymous-warning.title": "To udostępnienie jest anonimowe",
  "share.modal.anonymous-warning.description": "Ten plik pochodzi z anonimowego udostępnienia — mógł go tu wrzucić każdy, bez weryfikacji tożsamości. Traktuj go z taką samą ostrożnością jak pliki z otwartego internetu: nie używaj go do rozliczeń finansowych ani nie uruchamiaj go jako kod.",
  "share.modal.anonymous-warning.button.countdown": "Pobierz za {seconds}s",
  "share.modal.anonymous-warning.button.ready": "Pobierz",
  ...
  "admin.config.share.enable-share-email-recipients": "Enable email recipient sharing",
  ...
  "admin.config.share.warn-anonymous-shares": "Ostrzegaj o udostępnieniach anonimowych",
