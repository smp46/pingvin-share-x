export default {
  ...
  "verify.info.description": "A verificação de e-mail está ativada. Enviamos um link de verificação para o seu endereço de e-mail. Por favor, clique no link para ativar sua conta.",
  ...
  "admin.config.general.default-language.description": "Isso se aplica a todos os usuários, cada usuário ainda pode personalizar seu idioma em seu perfil.",
  ...
  "admin.config.security.session-duration.description": "Tempo após o qual um usuário deve iniciar a sessão novamente (padrão: 3 meses).",
  "admin.config.appearance.logo": "Logotipo",
  "admin.config.appearance.logo.description": "Alterar o seu logo carregando uma nova imagem. A imagem deve ser PNG e deve ter o formato 1:1.",
  "admin.config.appearance.logo-dark": "Logotipo do modo escuro",
  "admin.config.appearance.logo-dark.description": "Carregue um logotipo separado para o modo escuro. A imagem deve ser um PNG e ter proporção 1:1.",
  ...
  "admin.config.security.custom-password-policy.description": "Se deve habilitar a personalização da política de senhas. Se desativado, a política de senhas padrão de no mínimo 8 caracteres será usada.",
  ...
  "admin.config.email.share-download-notification-message.description": "Mensagem que é enviada ao criador do compartilhamento quando um destinatário baixa um arquivo. Variáveis disponíveis:\n {recipientEmail} - O e-mail do destinatário\n {fileName} - O nome do arquivo baixado\n {shareUrl} - O URL do compartilhamento",
  "admin.config.security.enable-email-verification": "Habilitar verificação de e-mail",
  "admin.config.security.enable-email-verification.description": "Se deve exigir que os usuários verifiquem seu endereço de e-mail antes de poderem iniciar sessão. Isso só pode ser ativado se o SMTP estiver ativado.",
  "admin.config.email.verification-subject": "Assunto da verificação",
  "admin.config.email.verification-subject.description": "Assunto do e-mail que é enviado ao usuário quando ele se cadastra.",
  "admin.config.email.verification-message": "Mensagem de verificação",
  "admin.config.email.verification-message.description": "Mensagem enviada ao usuário quando ele se cadastra. {url} será substituído pelo URL de verificação.",
  ...
  "admin.config.share.file-retention-period.description": "Por quanto tempo os arquivos são mantidos após a expiração ou exclusão de um compartilhamento. Útil apenas se 'Permitir acesso de administrador a todos os compartilhamentos' também estiver habilitado. Defina como -1 para manter os arquivos para sempre.",
  ...
  "admin.config.s3.enabled.description": "Se o S3 deve ser usado para armazenar os arquivos compartilhados em vez do sistema de arquivos local. AVISO: Se o ClamAV estiver ativo, os arquivos serão baixados temporariamente do S3 para serem verificados.",
  ...
  "error.msg.email_already_exists": "Já existe uma conta com este endereço de e-mail. Por favor, inicie sessão com sua senha e vincule manualmente sua conta do {0} na página Minha conta.",
