export default {
  ...
  "verify.success":
    "Sua conta foi verificada com sucesso! Agora você pode iniciar sessão.",
  ...
  "verify.info.description":
    "A verificação de e-mail está ativada. Enviamos um link de verificação para o seu endereço de e-mail. Por favor, clique no link para ativar sua conta.",
  "verify.info.note":
  ...
  "account.shares.table.restricted-to-recipients":
    "Restrito apenas a destinatários",
  "account.shares.table.shared-with-recipients":
    "Compartilhado com destinatários",
  ...
  "account.received-shares.title.empty":
    "Nenhum compartilhamento recebido ainda",
  "account.received-shares.description.empty":
    "Os compartilhamentos enviados para seu endereço de e-mail aparecerão aqui.",
  ...
  "admin.users.edit.update.custom-share-size-limit":
    "Limite de tamanho de compartilhamento personalizado",
  "admin.users.edit.update.custom-share-size-limit.description":
    "Substituir o limite global de upload para este usuário",
  "admin.users.edit.update.custom-storage-quota-limit":
    "Cota de armazenamento personalizada",
  "admin.users.edit.update.custom-storage-quota-limit.description":
    "Limitar o uso total de armazenamento do usuário em compartilhamentos ativos",
  ...
  "upload.dropzone.description":
    "Arraste e solte arquivos ou pastas aqui para iniciar seu compartilhamento ou 'Ctrl+V' para carregar conteúdo de texto da área de transferência. Aceitamos apenas arquivos até {maxSize} no total.",
  ...
  "upload.modal.link.error.s3-session-not-found":
    "Sessão de upload S3 não encontrada",
  "upload.modal.link.error.s3-etag-missing":
    "Cabeçalho ETag ausente na resposta do S3. Certifique-se de que o CORS expõe o cabeçalho ETag.",
  ...
  "upload.modal.accordion.email.restrict-to-recipients":
    "Restringir o acesso apenas a estes destinatários (eles devem iniciar sessão para acessar)",
  ...
  "share.fileCount":
    "{count, plural, one {}=1 {# arquivo} other {# arquivos}} · {size} (arquivo zip pode ser menor devido à compressão)",
  "share.copy-text-contents":
    "Copiar conteúdo do arquivo para a área de transferência",
  ...
  "share.error.restricted.description":
    "Este compartilhamento é restrito a destinatários específicos. Por favor, inicie sessão para acessar.",
  ...
  "share.notify.copied-contents":
    "Conteúdo do arquivo copiado para a área de transferência",
  "share.notify.copy-too-big-error":
    "O arquivo é grande demais para ser copiado para a área de transferência",
  "share.notify.copy-not-supported-error":
    "Copiar para a área de transferência requer uma conexão HTTPS",
  ...
  "admin.config.config-file-warning.description":
    "Como você tem um Pingvin Share configurado com um arquivo de configuração, você não pode alterar a configuração através da UI.",
  ...
  "admin.config.general.default-language.description":
    "Isso se aplica a todos os usuários, cada usuário ainda pode personalizar seu idioma em seu perfil.",
  "admin.config.appearance.theme-primary-color": "Cor primária do tema",
  "admin.config.appearance.theme-primary-color.description":
    "Cor primária para botões, links e destaques. Escolha personalizado para usar uma cor de substituição.",
  ...
  "admin.config.appearance.theme-primary-color-override.description":
    "Cor hexadecimal de substituição quando a cor primária do tema estiver em personalizado.",
  "admin.config.appearance.theme-font-preset": "Predefinição de fonte",
  "admin.config.appearance.theme-font-preset.description":
    "Predefinição de fonte carregada no build. Escolha sistema ou uma das Google Fonts incluídas.",
  "admin.config.appearance.theme-color-scheme":
    "Esquema de cores padrão (visitantes)",
  "admin.config.appearance.theme-color-scheme.description":
    "Modo claro/escuro padrão para usuários não autenticados. Usuários autenticados usam a preferência da própria conta.",
  "admin.config.appearance.theme-radius": "Raio de borda do tema",
  "admin.config.appearance.theme-radius.description":
    "Raio de borda padrão usado pelos componentes Mantine.",
  "admin.config.appearance.custom-css": "CSS personalizado",
  "admin.config.appearance.custom-css.description":
    "CSS global aplicado ao frontend. Use com cuidado; CSS inválido pode afetar a interface.",
  "admin.config.appearance.upload-progress-style":
    "Estilo do progresso de upload",
  "admin.config.appearance.upload-progress-style.description":
    "Escolha como o progresso do upload é exibido na lista de arquivos.",
  ...
  "admin.config.appearance.logo-dark.description":
    "Carregue um logotipo separado para o modo escuro. A imagem deve ser um PNG e ter proporção 1:1.",
  ...
  "admin.config.security.require-special-character.description":
    "Se deve exigir pelo menos um caractere especial na senha.",
  ...
  "admin.config.cache.redis-enabled.description":
    "Normalmente informações de caches Pingvin Share na memória. Se você executar várias instâncias do Pingvin Share, você precisa habilitar o cache do Redis para compartilhar o cache entre as instâncias.",
  ...
  "admin.config.cache.test-redis.success-disabled":
    "Conectado ao Redis com sucesso (o cache Redis está desativado no momento).",
  ...
  "admin.config.cache.test-redis.modal.error.description":
    "Ao conectar ao Redis, ocorreu o seguinte erro:",
  "admin.config.cache.test-redis.modal.save.title": "Salvar configuração",
  "admin.config.cache.test-redis.modal.save.description":
    "Para continuar, você precisa salvar a configuração primeiro. Deseja salvar a configuração e testar a conexão Redis?",
  "admin.config.cache.test-redis.modal.save.confirm": "Salvar e testar",
  "admin.config.email.send-html-emails":
    "Habilitar compatibilidade de e-mail HTML",
  "admin.config.email.send-html-emails.description":
    "Se habilitado, os e-mails serão enviados no formato HTML. Certifique-se de que os modelos de e-mail foram atualizados para usar HTML.",
  ...
  "admin.config.share.enable-share-email-recipients.description":
    "Se deve permitir o compartilhamento por e-mail com destinatários. Isso só pode ser ativado se o SMTP estiver ativado.",
  ...
  "admin.config.email.share-recipients-reply-to-creator":
    "Definir Responder a para o e-mail do criador",
  "admin.config.email.share-recipients-reply-to-creator.description":
    "Se deve definir o cabeçalho Responder a (Reply-To) com o endereço de e-mail do usuário que criou o compartilhamento.",
  "admin.config.share.enable-share-download-notifications":
    "Habilitar notificações de download",
  "admin.config.share.enable-share-download-notifications.description":
    "Se deve enviar um e-mail para o criador do compartilhamento quando um destinatário baixar um arquivo. Isso requer SMTP e compartilhamento com destinatários por e-mail.",
  "admin.config.email.share-download-notification-subject":
    "Assunto da notificação de download",
  "admin.config.email.share-download-notification-subject.description":
    "Assunto do e-mail enviado ao criador do compartilhamento quando um destinatário baixa um arquivo.",
  "admin.config.email.share-download-notification-message":
    "Mensagem de notificação de download",
  "admin.config.email.share-download-notification-message.description":
    "Mensagem que é enviada ao criador do compartilhamento quando um destinatário baixa um arquivo. Variáveis disponíveis:\n {recipientEmail} - O e-mail do destinatário\n {fileName} - O nome do arquivo baixado\n {shareUrl} - O URL do compartilhamento",
  "admin.config.security.enable-email-verification":
    "Habilitar verificação de e-mail",
  "admin.config.security.enable-email-verification.description":
    "Se deve exigir que os usuários verifiquem seu endereço de e-mail antes de poderem iniciar sessão. Isso só pode ser ativado se o SMTP estiver ativado.",
  "admin.config.email.verification-subject": "Assunto da verificação",
  "admin.config.email.verification-subject.description":
    "Assunto do e-mail que é enviado ao usuário quando ele se cadastra.",
  "admin.config.email.verification-message": "Mensagem de verificação",
  "admin.config.email.verification-message.description":
    "Mensagem enviada ao usuário quando ele se cadastra. {url} será substituído pelo URL de verificação.",
  ...
  "admin.config.share.default-expiration.description":
    "O tempo de expiração padrão selecionado ao criar um novo compartilhamento.",
  ...
  "admin.config.security.allow-admin-access-all-shares":
    "Permitir acesso de administrador a todos os compartilhamentos",
  "admin.config.share.reverse-share-simple-only":
    "Forçar modo simples de compartilhamento reverso",
  "admin.config.share.reverse-share-simple-only.description":
    "Forçar a criação de compartilhamentos reversos no modo simples. Se desativado, o criador do compartilhamento reverso pode escolher entre o modo simples e avançado.",
  "admin.config.security.allow-admin-access-all-shares.description":
    "Permitir que os administradores acessem todos os compartilhamentos, mesmo se estiverem protegidos por senha, expirados ou excluídos.",
  "admin.config.share.enable-user-recipients":
    "Habilitar compartilhamento com usuários registrados",
  "admin.config.share.enable-user-recipients.description":
    "Quando habilitado, os compartilhamentos enviados para o endereço de e-mail de um usuário registrado aparecerão automaticamente na conta dele. Os usuários também podem restringir o acesso ao compartilhamento apenas aos destinatários indicados.",
  ...
  "admin.config.share.file-retention-period.description":
    "Por quanto tempo os arquivos são mantidos após a expiração ou exclusão de um compartilhamento. Útil apenas se 'Permitir acesso de administrador a todos os compartilhamentos' também estiver habilitado. Defina como -1 para manter os arquivos para sempre.",
  ...
  "admin.config.smtp.test-email.error.description":
    "Ao enviar o e-mail de teste, ocorreu o seguinte erro:",
  "admin.config.smtp.test-email.save.title": "Salvar configuração",
  "admin.config.smtp.test-email.save.description":
    "Para continuar, você precisa salvar a configuração primeiro. Deseja salvar a configuração e enviar o e-mail de teste?",
  ...
  "admin.config.s3.enabled.description":
    "Se o S3 deve ser usado para armazenar os arquivos compartilhados em vez do sistema de arquivos local. AVISO: Se o ClamAV estiver ativo, os arquivos serão baixados temporariamente do S3 para serem verificados.",
  ...
  "admin.config.s3.docs-link":
    "O CORS deve ser reconfigurado em seu bucket, consulte {wikiLink} para obter detalhes.",
  ...
  "error.msg.email_already_exists":
    "Já existe uma conta com este endereço de e-mail. Por favor, inicie sessão com sua senha e vincule manualmente sua conta do {0} na página Minha conta.",
  "error.msg.email_not_verified":
    "Seu endereço de e-mail nesta conta do {0} não está verificado. Por favor, verifique seu e-mail com o provedor de identidade antes de iniciar sessão.",
  ...
  "admin.notice.modal.defaultCheckboxLabel":
    "Confirmo que li este aviso e entendo as alterações de compatibilidade.",
  ...
  "admin.notice.modal.globalNoticeFooter":
    "Nota: Uma vez confirmado, este aviso será permanentemente dispensado para todos os administradores em todos os dispositivos.",
};
