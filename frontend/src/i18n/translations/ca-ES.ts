export default {
  ...
  "verify.info.note": "Si no rebeu el correu electrònic en uns minuts, comproveu la carpeta de correu brossa.",
  "verify.info.resend.button": "Torna a enviar el correu de verificació",
  "verify.info.resend.success": "El correu de verificació s'ha tornat a enviar correctament.",
  "verify.info.resend.error": "No s'ha pogut tornar a enviar el correu electrònic de verificació.",
  // END /auth/signup
  ...
  "account.shares.table.restricted-to-recipients": "Restringit només als destinataris",
  "account.shares.table.shared-with-recipients": "Compartit amb els destinataris",
  ...
  "account.received-shares.description.empty": "Les comparticions enviades a la vostra adreça de correu electrònic apareixeran aquí.",
  ...
  "admin.users.edit.update.custom-storage-quota-limit.description": "Limita l'ús total d'emmagatzematge de l'usuari en totes les comparticions actives",
  ...
  "admin.users.modal.create.custom-share-size-limit": "Límit de mida de compartició personalitzat",
  "admin.users.modal.create.custom-share-size-limit.description": "Substitueix el límit de pujada global per a aquest usuari",
  "admin.users.modal.create.custom-storage-quota-limit": "Quota d'emmagatzematge personalitzada",
  "admin.users.modal.create.custom-storage-quota-limit.description": "Limita l'ús total d'emmagatzematge de l'usuari en totes les comparticions actives",
  ...
  "upload.modal.link.error.s3-session-not-found": "No s'ha trobat la sessió de pujada a S3",
  "upload.modal.link.error.s3-etag-missing": "Falta la capçalera ETag a la resposta de S3. Assegureu-vos que CORS exposa la capçalera ETag.",
  ...
  "upload.modal.accordion.email.restrict-to-recipients": "Restringeix l'accés només a aquests destinataris (han d'iniciar sessió per accedir-hi)",
  ...
  "share.error.restricted.description": "Aquesta compartició està restringida a destinataris específics. Inicieu sessió per accedir-hi.",
  ...
  "admin.config.appearance.upload-progress-style.description": "Trieu com es mostra el progrés de la pujada a la llista de fitxers.",
  "admin.config.appearance.upload-progress-style.circle": "Indicador circular",
  "admin.config.appearance.upload-progress-style.circle-percentage": "Cercle amb percentatge",
  "admin.config.appearance.upload-progress-style.percentage-time": "Percentatge i temps restant",
  ...
  "admin.config.security.secure-cookies.description": "Si s'ha de configurar l'atribut secure a les galetes. Si està activat, el lloc no funcionarà si s'hi accedeix mitjançant HTTP.",
  ...
  "admin.config.security.custom-password-policy": "Política de contrasenyes personalitzada",
  ...
  "admin.config.security.min-length.description": "Nombre mínim de caràcters necessaris per a una contrasenya.",
  "admin.config.security.require-uppercase": "Requereix majúscules",
  "admin.config.security.require-uppercase.description": "Si cal requerir almenys una lletra majúscula a la contrasenya.",
  "admin.config.security.require-lowercase": "Requereix minúscules",
  "admin.config.security.require-lowercase.description": "Si cal requerir almenys una lletra minúscula a la contrasenya.",
  "admin.config.security.require-number": "Requereix números",
  "admin.config.security.require-number.description": "Si cal requerir almenys un número a la contrasenya.",
  "admin.config.security.require-special-character": "Requereix caràcters especials",
  "admin.config.security.require-special-character.description": "Si cal requerir almenys un caràcter especial a la contrasenya.",
  ...
  "admin.config.email.send-html-emails": "Habilita la compatibilitat de correu HTML",
  "admin.config.email.send-html-emails.description": "Si està activat, els correus s'enviaran en format HTML. Assegureu-vos que les plantilles de correu estan actualitzades per utilitzar HTML.",
  "admin.config.share.enable-share-email-recipients": "Activar la compartició de destinataris per correu",
  "admin.config.share.enable-share-email-recipients.description": "Si s'ha de permetre la compartició per correu amb els destinataris. Això només es pot activar si l'SMTP està activat.",
  ...
  "admin.config.email.share-recipients-reply-to-creator": "Estableix Respondre a al correu del creador",
  "admin.config.email.share-recipients-reply-to-creator.description": "Si s'ha d'establir la capçalera Respondre a a l'adreça de correu electrònic de l'usuari que ha creat la compartició.",
  "admin.config.share.enable-share-download-notifications": "Activar les notificacions de descàrrega",
  "admin.config.share.enable-share-download-notifications.description": "Si s'ha d'enviar un correu al creador de la compartició quan un destinatari del correu descarrega un fitxer. Això requereix l'SMTP i la compartició de destinataris per correu.",
  ...
  "admin.config.security.enable-email-verification": "Habilita la verificació per correu electrònic",
  ...
  "admin.config.security.allow-registration.description": "Si es permet el registre",
  "admin.config.security.allow-unauthenticated-shares": "Permetre comparticions no autenticades",
  "admin.config.security.allow-unauthenticated-shares.description": "Si els usuaris no autenticats poden crear comparticions",
  ...
  "admin.config.security.allow-admin-access-all-shares": "Permetre l'accés de l'administrador a totes les comparticions",
  "admin.config.share.reverse-share-simple-only": "Força el mode senzill de compartició inversa",
  "admin.config.share.reverse-share-simple-only.description": "Força que les comparticions inverses es creïn en mode senzill. Si està desactivat, el creador pot triar entre el mode senzill i l'avançat.",
  "admin.config.security.allow-admin-access-all-shares.description": "Permetre aos administradors accedir a totes les comparticions, fins i tot si estan protegides amb contrasenya, caducades o suprimides.",
  "admin.config.share.enable-user-recipients": "Habilita compartir amb usuaris registrats",
  "admin.config.share.enable-user-recipients.description": "Quan està activat, les comparticions enviades a l'adreça de correu electrònic d'un usuari registrat apareixeran automàticament al seu compte. Els usuaris també poden restringir l'accés a la compartició només als destinataris indicats.",
  ...
  "admin.config.s3.docs-link": "Cal reconfigurar CORS al vostre contenidor (bucket), consulteu {wikiLink} per a més detalls.",
  ...
  "error.msg.email_not_verified": "La vostra adreça de correu electrònic en aquest compte de {0} no està verificada. Verifiqueu el vostre correu amb el vostre proveïdor d'identitat abans d'iniciar sessió.",
  ...
  "common.error.password.lowercase": "La contrasenya ha de contenir almenys una lletra minúscula",
  "common.error.password.uppercase": "La contrasenya ha de contenir almenys una lletra majúscula",
  "common.error.password.number": "La contrasenya ha de contenir almenys un número",
  "common.error.password.special": "La contrasenya ha de contenir almenys un caràcter especial",
