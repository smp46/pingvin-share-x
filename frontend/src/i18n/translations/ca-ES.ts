export default {
  ...
  "verify.success": "El vostre compte s'ha verificat correctament! Ara podeu iniciar sessió.",
  ...
  "verify.info.description": "La verificació per correu electrònic està activada. Hem enviat un enllaç de verificació a la vostra adreça de correu electrònic. Feu clic a l'enllaç per activar el vostre compte.",
  ...
  "admin.config.security.session-duration.description": "Temps després del qual un usuari ha de tornar a iniciar sessió (per defecte: 3 mesos).",
  "admin.config.appearance.logo": "Logotip",
  "admin.config.appearance.logo.description": "Canvieu el vostre logotip pujant una nova imatge. La imatge ha de ser un PNG i ha de tenir el format 1:1.",
  "admin.config.appearance.logo-dark": "Logotip del mode fosc",
  "admin.config.appearance.logo-dark.description": "Pugeu un logotip independent per al mode fosc. La imatge ha de ser un PNG i ha de tenir el format 1:1.",
  ...
  "admin.config.security.custom-password-policy.description": "Si s'ha d'habilitar la personalització de la política de contrasenyes. Si està desactivat, s'utilitza la política per defecte d'un mínim de 8 caràcters.",
  ...
  "admin.config.security.enable-email-verification.description": "Si cal demanar als usuaris que verifiquin la seva adreça de correu electrònic abans de poder iniciar sessió. Només es pot activar si l'SMTP està activat.",
  "admin.config.email.verification-subject": "Assumpte de verificació",
  "admin.config.email.verification-subject.description": "Assumpte del correu electrònic que s'envia a l'usuari quan es registra.",
  "admin.config.email.verification-message": "Missatge de verificació",
  "admin.config.email.verification-message.description": "Missatge que s'envia a l'usuari quan es registra. {url} se substituirà per l'URL de verificació.",
  ...
  "admin.config.share.file-retention-period.description": "Quant de temps es conserven els fitxers després que una compartició caduqui o s'elimini. Només és útil si 'Permet l'accés d'administrador a totes les comparticions' també està activat. Establiu -1 per conservar els fitxers per sempre.",
  ...
  "error.msg.email_already_exists": "Ja existeix un compte amb aquesta adreça de correu electrònic. Inicieu sessió amb la vostra contrasenya i enllaceu manualment el vostre compte de {0} a la pàgina El meu compte.",
