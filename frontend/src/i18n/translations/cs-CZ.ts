export default {
  ...
  "admin.config.general.default-language.description": "Toto platí pro všechny uživatele, každý uživatel si však může jazyk přizpůsobit ve svém profilu.",
  ...
  "admin.config.security.session-duration.description": "Čas, po kterém se uživatel musí znovu přihlásit (výchozí: 3 měsíce).",
  "admin.config.appearance.logo": "Logo",
  "admin.config.appearance.logo.description": "Změňte své logo nahráním nového obrázku. Obrázek musí být PNG a měl by mít formát 1:1.",
  "admin.config.appearance.logo-dark": "Logo pro tmavý režim",
  "admin.config.appearance.logo-dark.description": "Nahrajte samostatné logo pro tmavý režim. Obrázek musí být formátu PNG s poměrem stran 1:1.",
  "admin.config.appearance.logo.placeholder": "Vybrat obrázek",
  "admin.config.security.custom-password-policy": "Vlastní zásady hesel",
  "admin.config.security.custom-password-policy.description": "Zda povolit přizpůsobení zásad hesel. Pokud je zakázáno, použijí se výchozí zásady s minimální délkou 8 znaků.",
  ...
  "admin.config.cache.ttl.description": "Doba v sekundách, po kterou se informace uchovávají v mezipaměti.",
  ...
  "admin.config.cache.redis-enabled.description": "Pingvin Share standardně ukládá informace do paměti. Pokud provozujete více instancí Pingvin Share, musíte povolit mezipaměť Redis pro sdílení dat mezi instancemi.",
  "admin.config.cache.redis-url": "URL adresa Redis",
  "admin.config.cache.redis-url.description": "URL adresa pro připojení k instanci Redis používané pro mezipaměť.",
  ...
  "admin.config.email.share-download-notification-message.description": "Zpráva odeslaná tvůrci sdílení, když příjemce stáhne soubor. Dostupné proměnné:\n {recipientEmail} - E-mail příjemce\n {fileName} - Název staženého souboru\n {shareUrl} - URL adresa sdílení",
  "admin.config.security.enable-email-verification": "Povolit ověření e-mailu",
  "admin.config.security.enable-email-verification.description": "Zda vyžadovat od uživatelů ověření e-mailové adresy před přihlášením. Toto lze povolit pouze v případě, že je aktivováno SMTP.",
  "admin.config.email.verification-subject": "Předmět ověření",
  "admin.config.email.verification-subject.description": "Předmět e-mailu odeslaného uživateli při registraci.",
  "admin.config.email.verification-message": "Zpráva ověření",
  "admin.config.email.verification-message.description": "Zpráva odeslaná uživateli při registraci. {url} bude nahrazeno ověřovací URL adresou.",
  ...
  "admin.config.share.file-retention-period.description": "Jak dlouho jsou soubory uchovávány po vypršení platnosti nebo smazání sdílení. Užitečné pouze v případě, že je povoleno také 'Povolit správci přístup ke všem sdílením'. Nastavte na -1 pro trvalé uchování souborů.",
  ...
  "admin.config.s3.enabled.description": "Zda se má pro ukládání sdílených souborů použít S3 namísto lokálního souborového systému. VAROVÁNÍ: Pokud je ClamAV aktivní, soubory se z S3 dočasně stáhnou ke kontrole.",
  ...
  "error.msg.email_already_exists": "Účet s touto e-mailovou adresou již existuje. Přihlaste se prosím svým heslem a ručně propojte svůj účet {0} na stránce Můj účet.",
