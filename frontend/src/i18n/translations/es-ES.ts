export default {
  ...
  "admin.config.security.custom-password-policy.description": "Indica si se habilita la personalización de la política de contraseñas. Si está desactivada, se utilizará la política predeterminada de un mínimo de 8 caracteres.",
  ...
  "error.msg.email_already_exists": "Ya existe una cuenta con esta dirección de correo electrónico. Por favor, inicia sesión con tu contraseña y vincula manualmente tu cuenta de {0} en tu página Mi cuenta.",
