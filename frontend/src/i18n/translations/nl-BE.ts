export default {
  ...
  "admin.config.email.enable-share-download-notifications": "Downloadmeldingen inschakelen",
  "admin.config.email.enable-share-download-notifications.description": "Of de maker van de share een e-mail ontvangt wanneer een ontvanger een bestand downloadt. Hiervoor moeten SMTP en delen met e-mailontvangers zijn ingeschakeld.",
  ...
  "admin.config.email.enable-email-verification.description": "Of gebruikers hun e-mailadres moeten verifiëren voordat ze zich kunnen aanmelden. Dit kan alleen worden ingeschakeld als SMTP actief is.",
