export default {
  ...
  "navbar.links.received": "Ontvangen bestanden",
  ...
  // /account/received
  "account.received-shares.title": "Ontvangen bestanden",
  "account.received-shares.title.empty": "Nog geen bestanden ontvangen",
  "account.received-shares.description.empty": "Bestanden die naar jouw e-mailadres worden gestuurd, verschijnen hier.",
  ...
  "admin.users.edit.update.custom-share-size-limit": "Aangepaste limiet voor delen",
  "admin.users.edit.update.custom-share-size-limit.description": "De globale uploadlimiet voor deze gebruiker overschrijven",
  ...
  "upload.button.add": "Toevoegen aan upload",
  // FileList.tsx
  "upload.filelist.name": "Naam",
  "upload.filelist.size": "Grootte",
  "upload.filelist.estimating": "Schatten...",
  "upload.filelist.remaining": "{time} resterend",
  ...
  "upload.modal.link.error.s3-etag-missing": "De ETag ontbreekt in de S3-response. Zorg ervoor dat CORS de ETag-header bevat.",
