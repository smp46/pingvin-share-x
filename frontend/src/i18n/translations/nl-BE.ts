export default {
  ...
  "common.button.showQRCode": "QR code weergeven",
  ...
  "admin.config.email.reverse-share-subject.description": "Onderwerp van de e-mail die werd verzonden toen iemand een bericht aanmaakte met uw link voor omgekeerd delen.",
