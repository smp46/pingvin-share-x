export default {
  ...
  "account.reverseShares.title": "文件收集",
  "account.reverseShares.description": "文件收集可生成一个专属链接，外部用户可通过该链接向您上传文件。",
  "account.reverseShares.title.empty": "这里空空如也 👀",
  "account.reverseShares.description.empty": "你没有创建任何预留共享",
  // showCreateReverseShareModal.tsx
  "account.reverseShares.modal.title": "创建文件收集",
  ...
  "admin.config.share.reverse-share-simple-only": "强制使用简易模式创建文件收集",
