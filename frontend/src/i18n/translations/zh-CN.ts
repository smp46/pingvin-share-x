export default {
  ...
  "account.shares.button.edit": "添加/删除文件",
  ...
  "upload.modal.expires.unit-label": "单位",
  ...
  "share.notify.copy-not-supported-error": "复制到剪贴板需要 HTTPS 连接",
  ...
  "admin.config.s3.region.description": "S3 桶所在的区域。",
