export default {
  ...
  "admin.config.security.custom-password-policy.description": "是否啟用自訂密碼原則。若停用，將使用預設的至少 8 個字元的密碼原則。",
  ...
  "error.msg.email_already_exists": "使用此電子郵件地址的帳號已存在。請使用密碼登入，並在「帳號設定」頁面中手動連結您的 {0} 帳號。",
