export default {
  ...
  "common.button.showQRCode": "顯示 QR 碼",
  ...
  "admin.users.edit.update.email-verified": "電子郵件已驗證",
  ...
  "upload.dropzone.description": "將檔案拖放至此以開始分享，或按「Ctrl+V」從剪貼簿上傳文字內容。我們僅接受總大小不超過 {maxSize} 的檔案。",
  ...
  "admin.config.cache.redis-url.description": "用於快取的 Redis 連線網址。",
  ...
  "admin.config.email.share-download-notification-subject.description": "當收件者下載檔案時，寄送給分享建立者的 Email 主旨。",
