export default {
  ...
  "account.received-shares.description.empty": "發送到您電子郵件地址的分享將顯示在此處。",
  ...
  "admin.users.edit.update.custom-storage-quota-limit.description": "限制該使用者在所有有效分享中的總儲存空間使用量",
  ...
  "admin.users.modal.create.custom-storage-quota-limit.description": "限制該使用者在所有有效分享中的總儲存空間使用量",
  ...
  "upload.modal.link.error.s3-etag-missing": "S3 回應中缺少 ETag 標頭。請確認 CORS 已公開 ETag 標頭。",
  ...
  "upload.modal.accordion.email.restrict-to-recipients": "僅限這些收件者存取（必須登入才能存取）",
  ...
  "share.error.restricted.description": "此分享僅限特定收件者存取。請登入以存取。",
  ...
  "admin.config.appearance.upload-progress-style.description": "選擇檔案列表中上傳進度的顯示方式。",
  "admin.config.appearance.upload-progress-style.circle": "圓形指示器",
  "admin.config.appearance.upload-progress-style.circle-percentage": "含百分比的圓形",
  "admin.config.appearance.upload-progress-style.percentage-time": "百分比與剩餘時間",
  ...
  "admin.config.security.require-uppercase.description": "密碼中是否需要至少包含一個大寫字母。",
  "admin.config.security.require-lowercase": "需要小寫字母",
  "admin.config.security.require-lowercase.description": "密碼中是否需要至少包含一個小寫字母。",
  "admin.config.security.require-number": "需要數字",
  "admin.config.security.require-number.description": "密碼中是否需要至少包含一個數字。",
  "admin.config.security.require-special-character": "需要特殊字元",
  "admin.config.security.require-special-character.description": "密碼中是否需要至少包含一個特殊字元。",
  ...
  "admin.config.email.share-recipients-reply-to-creator": "將 Reply-To 設為建立者的電子郵件",
  "admin.config.email.share-recipients-reply-to-creator.description": "是否將 Reply-To 標頭設為建立該分享之使用者的電子郵件地址。",
  ...
  "admin.config.share.enable-user-recipients.description": "啟用後，發送至已註冊使用者電子郵件地址的分享將自動顯示在其帳號中。使用者亦可將分享存取權限限制為僅限指定的收件者。",
  ...
  "admin.config.s3.docs-link": "必須在您的儲存貯體（Bucket）上重新設定 CORS，詳情請參閱 {wikiLink}。",
  ...
  "error.msg.email_not_verified": "您在此 {0} 帳號上的電子郵件地址尚未驗證。請在登入前先向您的識別提供者驗證電子郵件。",
