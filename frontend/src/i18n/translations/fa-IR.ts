export default {
  ...
  "navbar.links.received": "اشتراک‌های دریافت‌شده",
  ...
  "admin.users.table.storageQuota": "سهمیه ذخیره‌سازی",
  "admin.users.table.maxShareSize": "حداکثر اندازه اشتراک",
  ...
  "upload.filelist.estimating": "در حال تخمین...",
  ...
  "admin.config.category.security": "امنیت و دسترسی",
